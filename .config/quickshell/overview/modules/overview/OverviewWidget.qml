...
Item {
    ...
    readonly property bool useWorkspaceMap: Config.options.overview?.useWorkspaceMap ?? false
    ...
    property bool showSpecialWorkspaces: Config.options.overview?.showSpecialWorkspaces ?? true
    ...
    property bool glassMode: Config.options.overview?.effects?.glassMode ?? false
    ...
    property bool previewsEnabled: Config.options.overview?.previewsEnabled ?? true
