...
Item { // Window
    ...
    property bool showIcons: Config.options.windowPreview?.showIcons ?? true
    property var iconToWindowRatio: Config.options.windowPreview?.iconToWindowRatio ?? 0.25
    property var xwaylandIndicatorToIconRatio: Config.options.windowPreview?.xwaylandIndicatorToIconRatio ?? 0.35
    property var iconToWindowRatioCompact: Config.options.windowPreview?.iconToWindowRatioCompact ?? 0.45
    property bool cropToFill: Config.options.windowPreview?.cropToFill ?? false
